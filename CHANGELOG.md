...
### Изменено
- Глобальная инженерная политика стала риск-ориентированной: тесты обязательны
  для регрессий и изменений с высокой ценой ошибки, а низко- и
  среднерисковые правки больше не требуют теста на каждую функцию.
- Субагентское ревью ограничено одной независимой проверкой для рискованных или
  межкомпонентных изменений; per-task review и бесконечные циклы перепроверки
  больше не являются глобальным дефолтом.
